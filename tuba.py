...
class details:
    ...
    def __init__(self, root):
        ...
        self.root.wm_iconbitmap('v.ico')

        self.root.config(bg="white")

        self.left = ImageTk.PhotoImage(file="tuba.jpg")
        left = Label(self.root, image=self.left).place(x=5, y=5, width=200, height=201)

        f_name = Label(self.root, text="Name: Tuba", font=("times new roman", 18, 'bold'),bg="white").place(
            x=0, y=210)
        ...
        Home_district = Label(self.root, text="Home district: Norshindi ", font=("times new roman", 18, 'bold'),
                          bg="white").place(
            x=0, y=350)

        Current_city = Label(self.root, text="Current city: Dhaka", font=("times new roman", 18, 'bold'),
                          bg="white").place(
            x=0, y=380)
